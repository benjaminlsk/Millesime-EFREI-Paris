...
const callsToAction = [{ name: "Contact", href: "#", icon: PhoneIcon }];
const events = [
  {
    name: "Events",
    description:
...
const wine = [
  {
    name: "Bourgogne Cuvée 2019",
    description: "See what we think about it!",
    href: "#",
    icon: CalendarIcon,
  },
  {
    name: "Chateau de la Roche 2019",
    description: "See what we think about it!",
    href: "#",
    icon: LifebuoyIcon,
  },
...
const base = [
  {
    name: "Comment gouter le vin",
    description: "Le tutoriel pour gouter le vin ;)",
    href: "#",
    icon: CalendarIcon,
  },
];
const contact = [
  {
    name: "Contact",
    description: "Find all of our networks.",
    href: "#",
    icon: LifebuoyIcon,
  },
];
                  ...
                  >
                    <Popover.Panel className="absolute z-10 -ml-4 mt-3 w-screen max-w-md transform px-2 sm:px-0 lg:left-1/2 lg:ml-0 lg:-translate-x-1/2">
                      <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                        ...
                        <div className="space-y-6 bg-#800020 px-5 py-5 sm:flex sm:space-y-0 sm:space-x-10 sm:px-8">
