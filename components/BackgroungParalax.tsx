    ...
    <div className="isolate overflow-hidden mt-16 bg-gray-900 py-24 sm:py-32 relative">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          <h2 className="text-4xl ml-6 font-bold tracking-tight text-white sm:text-6xl">
            Millésime{" "}
          </h2>
          ...
          <dl className="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
            {stats.map((stat) => (
              <div key={stat.name} className="flex flex-col-reverse">
                <dt className="text-base ml-10 leading-7 text-gray-300">
                  {stat.name}
                </dt>
                <dd className="text-2xl ml-10 font-bold leading-9 tracking-tight text-white">
                  {stat.value}
                </dd>
              </div>
            ))}
