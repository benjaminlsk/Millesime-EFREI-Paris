  ...
  return (
    <div className="py-24 sm:py-32 bg-gray-50">
      ...
      <div className="mx-10 my-10 w-1280 px-5 gap-y-20 gap-x-8 lg:px-8 ">
        <ul
          role="list"
          className="grid gap-x-8 gap-y-15 w-58 h-58 items-center mx-2 sm:grid-cols-3 sm:gap-y-8 xl:col-span-2 flex-row"
        >
          {people.map((person) => (
            <>
              <li key={person.name}>
                <div className="grid items-center text-center bg-white rounded shadow-xl">
                  ...
                  <div className="rounded ">
                    <h3 className="text-base font-semibold pb-1 leading-7 tracking-tight text-gray-900 text-bold">
                      {person.name}
                    </h3>
                    <div className="text-xs text-center inline-flex items-center font-bold uppercase px-3 py-2 mb-2 bg-red-400 text-white rounded-full">
                      {person.role}
                    </div>
                  </div>
                </div>
